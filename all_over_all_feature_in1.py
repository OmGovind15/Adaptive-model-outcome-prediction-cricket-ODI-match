...
OUTPUT_DIR = "unified_model_analysis_innings1" # Dir for the UNIFIED models
...
def train_unified_nn_cv(X_train_data, y_train_data, device, epochs=50, k_folds=5):
    """
    Trains the unified NN using k-fold CV, logic copied from final_in1.py
    """
...
print("Starting Unified Model Training for Innings 1...")
...
# 3. Define models and GridSearchCV (Copied from final_in1.py)
...
print("\n✅ Unified model training for Innings 1 complete.")